    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <?Php 
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Add a meal</h1>
        ...
        <form method="post" action="<?= $framework_route::from2('back', 'controllers', 'composemeal') ?>">
                  ...
                  <table class="table">
                            ...
                            foreach($types as $type){
                              ?>
                                ...
                                <tr>
                                <td><input type="radio" name="type" value="<?= $type->id ?>"></td>
                  ...
                  <table class="table">
                            ...
                            foreach($arounds as $around){
                              ?>
                                ...
                                <tr>
                                <td><input type="checkbox" name="arounds[]" value="<?= $around->id ?>"></td>
                  ...
                  <table class="table">
                            ...
                            foreach($sizes as $size){
                              ?>
                                ...
                                <tr>
                                <td><input type="radio" name="size" value="<?= $size->id ?>"></td>
